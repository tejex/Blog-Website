...
//******************************************************************************************************************//
//Incorporating mongoDB into the blog website

const password = encodeURIComponent("Gtalebron@23")
const uri = `mongodb+srv://bamMongo23:${password}@cluster0.wvbvubq.mongodb.net/blogWebsiteData`;
...
app.get("/",function(req,res){
  ...
  Post.find(function(err, foundPosts){
    if(err){
      ...
      res.render("home",{info:homeStartingContent,newPost:foundPosts})
    }
  })
})
//******************************************************************************************************************//
